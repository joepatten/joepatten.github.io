...
| :--- | :--- | :--- |
| 1 | - [Old Linear Algebra Notes]({{ site.baseurl }}/assets/pdfs/math_bootcamp/Mathcamp_Linear_Algebra.pdf)<br> - [Lecture 1 - Linear Algebra]({{ site.baseurl }}/assets/pdfs/math_bootcamp/Lecture1.pdf)<br> - [Lecture 2 - Linear Algebra]({{ site.baseurl }}/assets/pdfs/math_bootcamp/Lecture2.pdf)<br> - [Lecture 3 - Linear Algebra]({{ site.baseurl }}/assets/pdfs/math_bootcamp/Lecture3.pdf)<br> - [Lecture 4 - Linear Algebra]({{ site.baseurl }}/assets/pdfs/math_bootcamp/Lecture4.pdf)  | - [Link to advice for incoming Economics PhD students](https://economics.cornell.edu/grad-student-advice)<br> - [Latex Tutorial pdf]({{ site.baseurl }}/assets/pdfs/tutorials/latex_tutorial.pdf) and [Latex Zip Folder (containing tex and other necessary files)]({{ site.baseurl }}/assets/zips/latex_tutorial.zip)<br> - [Sets and Logic Reading]({{ site.baseurl }}/assets/pdfs/math_bootcamp/sets_and_logic_reading.pdf) |
